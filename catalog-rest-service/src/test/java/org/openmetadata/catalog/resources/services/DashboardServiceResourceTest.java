...
public class DashboardServiceResourceTest extends EntityResourceTest<DashboardService> {
  ...
  @Test
  public void post_validService_as_admin_200_ok(TestInfo test)
  ...
  public void put_updateService_as_admin_2xx(TestInfo test) throws IOException, URISyntaxException {
    DashboardService service =
        createAndCheckEntity(
            create(test).withDescription(null).withIngestionSchedule(null), adminAuthHeaders());
  ...
  public void delete_notExistentDashboardService() {
    ...
    TestUtils.assertResponse(
        ...
        CatalogExceptionMessage.entityNotFound(
            Entity.DASHBOARD_SERVICE, TestUtils.NON_EXISTENT_ENTITY));
  }
  ...
  public void validateCreatedEntity(
      DashboardService service, Object request, Map<String, String> authHeaders) {
  ...
  @Override
  public void validateGetWithDifferentFields(DashboardService service, boolean byName)
