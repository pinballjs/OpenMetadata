...
@Collection(name = "locations", repositoryClass = "org.openmetadata.catalog.jdbi3.LocationRepository")
public class LocationResource {
    ...
    public static List<Location> addHref(UriInfo uriInfo, List<Location> locations) {
        Optional.ofNullable(locations).orElse(Collections.emptyList()).forEach(i -> addHref(uriInfo, i));
        return locations;
    }
    ...
    @Inject
    public LocationResource(LocationRepository dao, CatalogAuthorizer authorizer) {
    ...
    public LocationList list(@Context UriInfo uriInfo,
        ...
        LocationResource.LocationList locations;
        ...
        addHref(uriInfo, locations.getData());
        return locations;
    }
    ...
    public Location get(@Context UriInfo uriInfo, @PathParam("id") String id,
                        @Context SecurityContext securityContext,
                        @Parameter(description = "Fields requested in the returned resource",
                                schema = @Schema(type = "string", example = FIELDS))
    ...
    public Response getByName(@Context UriInfo uriInfo, @PathParam("fqn") String fqn,
                              ...
                              @QueryParam("fields") String fieldsParam) throws IOException {
        EntityUtil.Fields fields = new EntityUtil.Fields(FIELD_LIST, fieldsParam);
        Location location = dao.getByName(fqn, fields);
        addHref(uriInfo, location);
    ...
    public Response create(@Context UriInfo uriInfo, @Context SecurityContext securityContext,
        ...
        Location location =
                new Location().withId(UUID.randomUUID()).withName(create.getName())
                        .withDescription(create.getDescription())
                        .withLocationType(create.getLocationType())
                        .withTags(create.getTags());
        location = addHref(uriInfo, dao.create(location, create.getService(), create.getOwner()));
    ...
    public Response createOrUpdate(@Context UriInfo uriInfo,
        ...
        PutResponse<Location> response = dao.createOrUpdate(location, create.getService(), create.getOwner());
    ...
    public Response addFollower(@Context UriInfo uriInfo,
        ...
        EntityUtil.Fields fields = new EntityUtil.Fields(FIELD_LIST, "followers");
