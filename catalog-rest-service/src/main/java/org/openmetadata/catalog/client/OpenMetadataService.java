...
public class OpenMetadataService {
  ...
  private static Database getDatabaseByName(String name, String fields, Map<String, String> authHeaders)
          throws HttpResponseException {
  ...
  private static boolean existsDatabaseByName(String name, Map<String, String> authHeaders)
          throws HttpResponseException {
    boolean found = false;
    try {
  ...
  public static DatabaseService createDatabaseService(CreateDatabaseService create, Map<String, String> authHeaders)
          throws HttpResponseException {
  ...
  public static boolean existsDatabaseServiceByName(String name, Map<String, String> authHeaders)
          throws HttpResponseException {
    boolean found = false;
    try {
  ...
  private static Table getTableByName(String name, String fields, Map<String, String> authHeaders)
          throws HttpResponseException {
  ...
  private static StorageService getStorageServiceByName(String name, String fields, Map<String, String> authHeaders)
          throws HttpResponseException {
  ...
  private static boolean existsStorageServiceByName(String name, Map<String, String> authHeaders)
          throws HttpResponseException {
    boolean found = false;
    try {
  ...
  public static Location createLocation(CreateLocation create, Map<String, String> authHeaders)
          throws HttpResponseException {
    String encodedFqn = URLEncoder.encode(create.getService().getName() + "." + create.getName(),
  ...
  public static Location getLocationByName(String name, String fields, Map<String, String> authHeaders)
          throws HttpResponseException {
  ...
  private static boolean existsLocationByName(String name, Map<String, String> authHeaders)
          throws HttpResponseException {
    boolean found = false;
    try {
  ...
  public static void addLocationToTable(Location location, Table table, Map<String, String> authHeaders)
          throws HttpResponseException {
  ...
  private static User getUserByName(String name, String fields, Map<String, String> authHeaders)
          throws HttpResponseException {
  ...
  private static void addUsersToTeam(List<UUID> users, Team team, Map<String, String> authHeaders)
          throws HttpResponseException {
    for (UUID id : users) {
      ...
      teams.add(new EntityReference().withId(team.getId()).withName(team.getName())
              .withDescription(team.getDescription()).withDisplayName(team.getDisplayName()).withType(TEAM));
  ...
  private static Team getTeamByName(String name, String fields, Map<String, String> authHeaders)
          throws HttpResponseException {
  ...
  public static LocationList listPrefixes(String fields, String fqn, String limit, String before, String after,
