...
public class OpenMetadataService {
    ...
    public static LocationList listPrefixes(String fields, String fqn, String limit, String before, String after, Map<String, String> authHeaders) throws HttpResponseException {
